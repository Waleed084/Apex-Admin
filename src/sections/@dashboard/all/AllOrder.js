...
export default function ToggleButtons() {
  ...
  const handleStatusChange = async () => {
    if(selectedType === 'divan'){
      ...
      const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/submissions/all-devan`);
      ...
      try {
        ...
        // Fetch the updated data from the server
      const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/submissions/all-sleigh`);
      ...
      try {
        ...
        // Fetch the updated data from the server
      const response = await axios.get(`${process.env.REACT_APP_API_HOST}/api/submissions/all-mattress`);
